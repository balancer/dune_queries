-- Volume (token breakdown without AAVE, BAL, DAI, USDC, WBTC & WETH) per day (last 7 days)
...
WITH swaps AS (
        ...
        AND d.token_b_address NOT IN ('\x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9',
        ...
        AND ('{{4. Version}}' = 'Both' OR version = SUBSTRING('{{4. Version}}', 2))
        AND d.token_a_address NOT IN ('\x7fc66500c84a76ad7e9c93437bfc5ac33e2ddae9',
                                    '\xba100000625a3754423978a60c9317c58a424e3d',
                                    '\x6b175474e89094c44da98b954eedeac495271d0f',
                                    '\xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48',
                                    '\xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2',
