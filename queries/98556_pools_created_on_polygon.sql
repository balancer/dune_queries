...
FULL OUTER JOIN weighted_2tokens_pools w2 ON w2.week = w.week
FULL OUTER JOIN stable_pools st ON st.week = w.week
WHERE (w.week >= '{{2. Start date}}' AND w.week <= '{{3. End date}}')
